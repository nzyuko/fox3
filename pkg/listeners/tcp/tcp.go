...
// TCP listener's do not have a server because the Fox3 Server does not send/receive messages. They are sent through
...
// Server is not used by TCP listeners because the Fox3 Server itself does not listen for or send Agent messages.
