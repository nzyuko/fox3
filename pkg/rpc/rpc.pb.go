...
var file_pkg_rpc_rpc_proto_depIdxs = []int32{
	...
	1,  // 12: rpc.Fox3.Reconnect:input_type -> rpc.ID
	25, // 13: rpc.Fox3.Register:input_type -> google.protobuf.Empty
	1,  // 14: rpc.Fox3.Listen:input_type -> rpc.ID
	7,  // 15: rpc.Fox3.Any:input_type -> rpc.AgentCMD
	7,  // 16: rpc.Fox3.CD:input_type -> rpc.AgentCMD
	1,  // 17: rpc.Fox3.CheckIn:input_type -> rpc.ID
	1,  // 18: rpc.Fox3.ClearJobs:input_type -> rpc.ID
	25, // 19: rpc.Fox3.ClearJobsCreated:input_type -> google.protobuf.Empty
	7,  // 20: rpc.Fox3.CMD:input_type -> rpc.AgentCMD
	7,  // 21: rpc.Fox3.Connect:input_type -> rpc.AgentCMD
	7,  // 22: rpc.Fox3.Download:input_type -> rpc.AgentCMD
	7,  // 23: rpc.Fox3.ENV:input_type -> rpc.AgentCMD
	7,  // 24: rpc.Fox3.ExecuteAssembly:input_type -> rpc.AgentCMD
	7,  // 25: rpc.Fox3.ExecutePE:input_type -> rpc.AgentCMD
	7,  // 26: rpc.Fox3.ExecuteShellcode:input_type -> rpc.AgentCMD
	1,  // 27: rpc.Fox3.Exit:input_type -> rpc.ID
	1,  // 28: rpc.Fox3.IFConfig:input_type -> rpc.ID
	7,  // 29: rpc.Fox3.InvokeAssembly:input_type -> rpc.AgentCMD
	7,  // 30: rpc.Fox3.JA3:input_type -> rpc.AgentCMD
	7,  // 31: rpc.Fox3.KillDate:input_type -> rpc.AgentCMD
	7,  // 32: rpc.Fox3.KillProcess:input_type -> rpc.AgentCMD
	7,  // 33: rpc.Fox3.LinkAgent:input_type -> rpc.AgentCMD
	1,  // 34: rpc.Fox3.ListAssemblies:input_type -> rpc.ID
	7,  // 35: rpc.Fox3.Listener:input_type -> rpc.AgentCMD
	7,  // 36: rpc.Fox3.LoadAssembly:input_type -> rpc.AgentCMD
	7,  // 37: rpc.Fox3.LoadCLR:input_type -> rpc.AgentCMD
	7,  // 38: rpc.Fox3.LS:input_type -> rpc.AgentCMD
	7,  // 39: rpc.Fox3.MaxRetry:input_type -> rpc.AgentCMD
	7,  // 40: rpc.Fox3.Memory:input_type -> rpc.AgentCMD
	7,  // 41: rpc.Fox3.MEMFD:input_type -> rpc.AgentCMD
	7,  // 42: rpc.Fox3.Netstat:input_type -> rpc.AgentCMD
	7,  // 43: rpc.Fox3.Note:input_type -> rpc.AgentCMD
	7,  // 44: rpc.Fox3.Nslookup:input_type -> rpc.AgentCMD
	7,  // 45: rpc.Fox3.Padding:input_type -> rpc.AgentCMD
	7,  // 46: rpc.Fox3.Parrot:input_type -> rpc.AgentCMD
	1,  // 47: rpc.Fox3.Pipes:input_type -> rpc.ID
	1,  // 48: rpc.Fox3.PS:input_type -> rpc.ID
	1,  // 49: rpc.Fox3.PWD:input_type -> rpc.ID
	7,  // 50: rpc.Fox3.RM:input_type -> rpc.AgentCMD
	7,  // 51: rpc.Fox3.RunAs:input_type -> rpc.AgentCMD
	7,  // 52: rpc.Fox3.SecureDelete:input_type -> rpc.AgentCMD
	7,  // 53: rpc.Fox3.SharpGen:input_type -> rpc.AgentCMD
	7,  // 54: rpc.Fox3.Skew:input_type -> rpc.AgentCMD
	7,  // 55: rpc.Fox3.Sleep:input_type -> rpc.AgentCMD
	7,  // 56: rpc.Fox3.Socks:input_type -> rpc.AgentCMD
	7,  // 57: rpc.Fox3.SSH:input_type -> rpc.AgentCMD
	7,  // 58: rpc.Fox3.Token:input_type -> rpc.AgentCMD
	7,  // 59: rpc.Fox3.Touch:input_type -> rpc.AgentCMD
	7,  // 60: rpc.Fox3.UnlinkAgent:input_type -> rpc.AgentCMD
	7,  // 61: rpc.Fox3.Upload:input_type -> rpc.AgentCMD
	1,  // 62: rpc.Fox3.Uptime:input_type -> rpc.ID
	25, // 63: rpc.Fox3.Groups:input_type -> google.protobuf.Empty
	16, // 64: rpc.Fox3.GroupAdd:input_type -> rpc.Group
	1,  // 65: rpc.Fox3.GroupList:input_type -> rpc.ID
	25, // 66: rpc.Fox3.GroupListAll:input_type -> google.protobuf.Empty
	16, // 67: rpc.Fox3.GroupRemove:input_type -> rpc.Group
	1,  // 68: rpc.Fox3.GetAgent:input_type -> rpc.ID
	25, // 69: rpc.Fox3.GetAgents:input_type -> google.protobuf.Empty
	1,  // 70: rpc.Fox3.GetAgentLinks:input_type -> rpc.ID
	1,  // 71: rpc.Fox3.GetAgentStatus:input_type -> rpc.ID
	25, // 72: rpc.Fox3.GetAgentRows:input_type -> google.protobuf.Empty
	1,  // 73: rpc.Fox3.Remove:input_type -> rpc.ID
	25, // 74: rpc.Fox3.GetAllJobs:input_type -> google.protobuf.Empty
	25, // 75: rpc.Fox3.GetAllActiveJobs:input_type -> google.protobuf.Empty
	1,  // 76: rpc.Fox3.GetAgentJobs:input_type -> rpc.ID
	1,  // 77: rpc.Fox3.GetAgentActiveJobs:input_type -> rpc.ID
	12, // 78: rpc.Fox3.CreateListener:input_type -> rpc.Options
	25, // 79: rpc.Fox3.GetListenerIDs:input_type -> google.protobuf.Empty
	25, // 80: rpc.Fox3.GetListeners:input_type -> google.protobuf.Empty
	1,  // 81: rpc.Fox3.GetListenerOptions:input_type -> rpc.ID
	19, // 82: rpc.Fox3.GetListenerDefaultOptions:input_type -> rpc.String
	25, // 83: rpc.Fox3.GetListenerTypes:input_type -> google.protobuf.Empty
	1,  // 84: rpc.Fox3.GetListenerStatus:input_type -> rpc.ID
	1,  // 85: rpc.Fox3.RemoveListener:input_type -> rpc.ID
	1,  // 86: rpc.Fox3.RestartListener:input_type -> rpc.ID
	7,  // 87: rpc.Fox3.SetListenerOption:input_type -> rpc.AgentCMD
	1,  // 88: rpc.Fox3.StartListener:input_type -> rpc.ID
	1,  // 89: rpc.Fox3.StopListener:input_type -> rpc.ID
	25, // 90: rpc.Fox3.Servers:input_type -> google.protobuf.Empty
	19, // 91: rpc.Fox3.GetModule:input_type -> rpc.String
	25, // 92: rpc.Fox3.GetModuleList:input_type -> google.protobuf.Empty
	22, // 93: rpc.Fox3.RunModule:input_type -> rpc.ModuleRun
	1,  // 94: rpc.Fox3.Reconnect:output_type -> rpc.ID
	1,  // 95: rpc.Fox3.Register:output_type -> rpc.ID
	10, // 96: rpc.Fox3.Listen:output_type -> rpc.Message
	10, // 97: rpc.Fox3.Any:output_type -> rpc.Message
	10, // 98: rpc.Fox3.CD:output_type -> rpc.Message
	10, // 99: rpc.Fox3.CheckIn:output_type -> rpc.Message
	10, // 100: rpc.Fox3.ClearJobs:output_type -> rpc.Message
	10, // 101: rpc.Fox3.ClearJobsCreated:output_type -> rpc.Message
	10, // 102: rpc.Fox3.CMD:output_type -> rpc.Message
	10, // 103: rpc.Fox3.Connect:output_type -> rpc.Message
	10, // 104: rpc.Fox3.Download:output_type -> rpc.Message
	10, // 105: rpc.Fox3.ENV:output_type -> rpc.Message
	10, // 106: rpc.Fox3.ExecuteAssembly:output_type -> rpc.Message
	10, // 107: rpc.Fox3.ExecutePE:output_type -> rpc.Message
	10, // 108: rpc.Fox3.ExecuteShellcode:output_type -> rpc.Message
	10, // 109: rpc.Fox3.Exit:output_type -> rpc.Message
	10, // 110: rpc.Fox3.IFConfig:output_type -> rpc.Message
	10, // 111: rpc.Fox3.InvokeAssembly:output_type -> rpc.Message
	10, // 112: rpc.Fox3.JA3:output_type -> rpc.Message
	10, // 113: rpc.Fox3.KillDate:output_type -> rpc.Message
	10, // 114: rpc.Fox3.KillProcess:output_type -> rpc.Message
	10, // 115: rpc.Fox3.LinkAgent:output_type -> rpc.Message
	10, // 116: rpc.Fox3.ListAssemblies:output_type -> rpc.Message
	10, // 117: rpc.Fox3.Listener:output_type -> rpc.Message
	10, // 118: rpc.Fox3.LoadAssembly:output_type -> rpc.Message
	10, // 119: rpc.Fox3.LoadCLR:output_type -> rpc.Message
	10, // 120: rpc.Fox3.LS:output_type -> rpc.Message
	10, // 121: rpc.Fox3.MaxRetry:output_type -> rpc.Message
	10, // 122: rpc.Fox3.Memory:output_type -> rpc.Message
	10, // 123: rpc.Fox3.MEMFD:output_type -> rpc.Message
	10, // 124: rpc.Fox3.Netstat:output_type -> rpc.Message
	10, // 125: rpc.Fox3.Note:output_type -> rpc.Message
	10, // 126: rpc.Fox3.Nslookup:output_type -> rpc.Message
	10, // 127: rpc.Fox3.Padding:output_type -> rpc.Message
	10, // 128: rpc.Fox3.Parrot:output_type -> rpc.Message
	10, // 129: rpc.Fox3.Pipes:output_type -> rpc.Message
	10, // 130: rpc.Fox3.PS:output_type -> rpc.Message
	10, // 131: rpc.Fox3.PWD:output_type -> rpc.Message
	10, // 132: rpc.Fox3.RM:output_type -> rpc.Message
	10, // 133: rpc.Fox3.RunAs:output_type -> rpc.Message
	10, // 134: rpc.Fox3.SecureDelete:output_type -> rpc.Message
	10, // 135: rpc.Fox3.SharpGen:output_type -> rpc.Message
	10, // 136: rpc.Fox3.Skew:output_type -> rpc.Message
	10, // 137: rpc.Fox3.Sleep:output_type -> rpc.Message
	10, // 138: rpc.Fox3.Socks:output_type -> rpc.Message
	10, // 139: rpc.Fox3.SSH:output_type -> rpc.Message
	10, // 140: rpc.Fox3.Token:output_type -> rpc.Message
	10, // 141: rpc.Fox3.Touch:output_type -> rpc.Message
	10, // 142: rpc.Fox3.UnlinkAgent:output_type -> rpc.Message
	10, // 143: rpc.Fox3.Upload:output_type -> rpc.Message
	10, // 144: rpc.Fox3.Uptime:output_type -> rpc.Message
	15, // 145: rpc.Fox3.Groups:output_type -> rpc.Slice
	10, // 146: rpc.Fox3.GroupAdd:output_type -> rpc.Message
	15, // 147: rpc.Fox3.GroupList:output_type -> rpc.Slice
	18, // 148: rpc.Fox3.GroupListAll:output_type -> rpc.GroupMembers
	10, // 149: rpc.Fox3.GroupRemove:output_type -> rpc.Message
	2,  // 150: rpc.Fox3.GetAgent:output_type -> rpc.AgentInfo
	15, // 151: rpc.Fox3.GetAgents:output_type -> rpc.Slice
	15, // 152: rpc.Fox3.GetAgentLinks:output_type -> rpc.Slice
	10, // 153: rpc.Fox3.GetAgentStatus:output_type -> rpc.Message
	14, // 154: rpc.Fox3.GetAgentRows:output_type -> rpc.TableData
	10, // 155: rpc.Fox3.Remove:output_type -> rpc.Message
	9,  // 156: rpc.Fox3.GetAllJobs:output_type -> rpc.Jobs
	9,  // 157: rpc.Fox3.GetAllActiveJobs:output_type -> rpc.Jobs
	9,  // 158: rpc.Fox3.GetAgentJobs:output_type -> rpc.Jobs
	9,  // 159: rpc.Fox3.GetAgentActiveJobs:output_type -> rpc.Jobs
	10, // 160: rpc.Fox3.CreateListener:output_type -> rpc.Message
	15, // 161: rpc.Fox3.GetListenerIDs:output_type -> rpc.Slice
	14, // 162: rpc.Fox3.GetListeners:output_type -> rpc.TableData
	12, // 163: rpc.Fox3.GetListenerOptions:output_type -> rpc.Options
	12, // 164: rpc.Fox3.GetListenerDefaultOptions:output_type -> rpc.Options
	15, // 165: rpc.Fox3.GetListenerTypes:output_type -> rpc.Slice
	10, // 166: rpc.Fox3.GetListenerStatus:output_type -> rpc.Message
	10, // 167: rpc.Fox3.RemoveListener:output_type -> rpc.Message
	10, // 168: rpc.Fox3.RestartListener:output_type -> rpc.Message
	10, // 169: rpc.Fox3.SetListenerOption:output_type -> rpc.Message
	10, // 170: rpc.Fox3.StartListener:output_type -> rpc.Message
	10, // 171: rpc.Fox3.StopListener:output_type -> rpc.Message
	15, // 172: rpc.Fox3.Servers:output_type -> rpc.Slice
	21, // 173: rpc.Fox3.GetModule:output_type -> rpc.Module
	15, // 174: rpc.Fox3.GetModuleList:output_type -> rpc.Slice
	11, // 175: rpc.Fox3.RunModule:output_type -> rpc.Messages
