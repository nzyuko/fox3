...
// publicly distributed key pair from the Fox3 repository. Anyone could decrypt the TLS traffic
func CheckInsecureFingerprint(certificate tls.Certificate) (bool, error) {
	...
	// fox3CRT is the string representation of the SHA1 fingerprint for the public x.509 certificate distributed with Fox3
	fox3CRT := "4af9224c77821bc8a46503cfc2764b94b1fc8aa2521afc627e835f0b3c449f50"

	// Check to see if the Public Key SHA1 finger print matches the certificate distributed with Fox3 for testing
	if fox3CRT == sha256Fingerprint {
		return true, nil
	}
	return false, nil
}
