# Contributing
Thank you for your interest in contributing to Fox3. This document
...
Go is slightly unique due to the way it imports packages. Simply forking
 Fox3 and getting to work will result in problems due to imports. The
 proper way to work with a Go repository after forking it is:
1. Grab Fox3 into your GOPATH `go get github.com/nzyuko/fox3`
2. Rename the current origin remote to upstream
`git remote rename origin upstream`
3. Add your fork as origin
`git remote add origin https://github.com/<your user name>/fox3`
...
# Agent Messages
Fox3 Agents are designed to run on a compromised host during a
...
# Contributors
Thank you to everyone that has contributed to Fox3. Your contributions
 help keep Fox3 great and valuable.
